...
#    input = cms.untracked.int32(4848)
    input = cms.untracked.int32(-1)
)

# Input source
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:/afs/cern.ch/work/r/rchudasa/private/CMSSW_8_1_0_pre11/src/new_pick/hybrid_pick_event.root'),
#fileNames = cms.untracked.vstring('root://cms-xrd-global.cern.ch//store/hidata/HIRun2015/HIForward/RAW/v1/000/262/656/00000/CC3710A8-4594-E511-B8F5-02163E0134CB.root'),
...
process.AODoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('RECO_FILTER_RAW2DIGI_L1Reco_AOD_double_eg2_trigger_only.root'),
...
process.hltPerhiphHI = cms.EDFilter("HLTHighLevel",
    HLTPaths = cms.vstring(
       ...
       # 'HLT_HISinglePhoton*_Eta*_Cent50_100_*'
